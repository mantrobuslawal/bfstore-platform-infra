# Self-Manage Selected Platform Services For Learning
...
bfstore will self-manage selected platform components where doing so demonstrates operational competence, while documenting managed-service alternatives.
