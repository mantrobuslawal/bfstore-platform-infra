# Separate Observability Control Plane From Production
...
bfstore will keep collectors near workloads but host central dashboards, alerting and observability control outside production.
