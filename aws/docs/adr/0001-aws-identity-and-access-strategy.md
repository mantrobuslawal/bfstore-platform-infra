# Adopt Federated Role-Based AWS Identity
...
bfstore will use IAM Identity Center for workforce access, GitHub OIDC/STS for CI/CD, explicit workload identities for Kubernetes services, and least-privilege policies wherever practical.
