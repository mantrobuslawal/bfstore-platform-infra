# Use Phased Centralised Networking
...
bfstore will start with non-overlapping per-account VPCs and progressively introduce Transit Gateway, IPAM, DNS and inspection through the Network account.
