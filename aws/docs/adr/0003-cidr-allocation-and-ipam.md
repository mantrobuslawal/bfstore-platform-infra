# Centralise CIDR Allocation And Future IPAM
...
bfstore will maintain a central CIDR plan initially and move toward Network-account-owned AWS VPC IPAM as the platform matures.
