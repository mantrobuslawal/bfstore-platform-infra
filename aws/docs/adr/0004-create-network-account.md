# Create Dedicated Network Account
...
bfstore will include a Network account under the Infrastructure OU from day one to own central network governance, CIDR/IPAM strategy, Transit Gateway and future egress/inspection.
