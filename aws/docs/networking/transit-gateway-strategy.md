...
Define how Transit Gateway will be introduced and governed.
...
- Create TGW in the Network account.
- Use explicit TGW route tables.
- Start with dev/shared-services attachments.
- Treat TGW changes as high blast-radius changes.
